...
export default function HonetopProductionPage() {
  ...
  const canClose = Boolean(form.productName.trim() && form.productionDate && form.productionLot.trim() && form.productionExpiry && unitsToProduce > 0 && pallets.length > 0 && producedTotal >= unitsToProduce)
