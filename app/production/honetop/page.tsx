...
export default function HonetopProductionPage() {
  ...
  const fields: Array<[keyof typeof initial, string, string]> = [["producedUnits", "Unidades produzidas", "number"], ["bagsInRoom", "Sacos entrados na sala", "number"], ["lowerValueBags", "Sacos de menor valor", "number"], ["requestedQuantity", "Quantidade requisitada", "number"], ["lot", "Lote", "text"], ["expiry", "Validade", "date"]]
