...
export default function HonetopProductionPage() {
  ...
  const requiredMeBags = recipeMaterials.find((material) => material.name.toLowerCase().includes("saco"))?.quantityPerUnit ? unitsToProduce * (recipeMaterials.find((material) => material.name.toLowerCase().includes("saco"))?.quantityPerUnit ?? 1) : unitsToProduce
  const requiredMeScoops = recipeMaterials.find((material) => material.name.toLowerCase().includes("scoop"))?.quantityPerUnit ? unitsToProduce * (recipeMaterials.find((material) => material.name.toLowerCase().includes("scoop"))?.quantityPerUnit ?? 1) : unitsToProduce
