  ...
  async function requestMaterials() {
    ...
    try {
      ...
      const requests: MaterialRequest[] = [
        { id: `request_honetop_me_bags_${Date.now()}`, stockItemId: "honetop-me-bags", materialName: "Sacos ME · Honetop", quantity: requiredMeBags, unit: "un", requester: "Produção Honetop", status: "requested", requestedAt: now },
        { id: `request_honetop_me_scoops_${Date.now() + 1}`, stockItemId: "honetop-me-scoops", materialName: "Scoops ME · Honetop", quantity: requiredMeScoops, unit: "un", requester: "Produção Honetop", status: "requested", requestedAt: now },
        { id: `request_honetop_raw_${Date.now() + 2}`, stockItemId: "honetop-raw-material", materialName: "Matéria-prima · Honetop", quantity: requiredRawKg, unit: "kg", requester: "Produção Honetop", status: "requested", requestedAt: now },
      ]
