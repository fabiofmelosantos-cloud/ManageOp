  ...
  sections: [
    {
      ...
      children: [
        ...
        numbered("Fechar as paletes de matéria-prima recebida (sacos, lote e validade).", "honetop-steps"),
        ...
        h2("Horários"),
        para("Gera o horário do Turno 1 com rotação justa das horas de almoço."),
        bullet("Selecione o dia a organizar."),
        bullet("Gere ou ajuste o horário dos trabalhadores."),
        bullet("Confirme a rotação das horas de almoço."),
