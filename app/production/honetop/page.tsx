...
const initial = { productName: "", bagsInRoom: "", bagKg: "0.5", lowerValueBags: "", totalToProduce: "", lot: "", expiry: "", requestedQuantity: "", palletQuantity: "", palletNumber: "", channel: "HQ" }
  ...
  async function requestMaterials() {
    ...
    try {
      ...
      const requests: MaterialRequest[] = [
        { id: `request_honetop_me_bags_${Date.now()}`, stockItemId: "honetop-me-bags", materialName: `Sacos ME · ${form.productName || "Honetop"}`, quantity: requiredMeBags, unit: "un", requester: "Produção Honetop", destinationRoom: "Honetop", status: "requested", requestedAt: now },
        { id: `request_honetop_me_scoops_${Date.now() + 1}`, stockItemId: "honetop-me-scoops", materialName: `Scoops ME · ${form.productName || "Honetop"}`, quantity: requiredMeScoops, unit: "un", requester: "Produção Honetop", destinationRoom: "Honetop", status: "requested", requestedAt: now },
