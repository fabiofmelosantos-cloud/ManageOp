...
export const pageGuides: Record<string, PageGuide> = {
  ...
  "/production/honetop": {
    ...
    steps: [
      ...
      "4. Definir a produção do dia, arrancar o cronómetro e indicar operadores. A MP real consumida (MP que entrou no ponto 3 menos a sobra real) aparece em kg e em sacos de 25 kg; a sobra teórica compara o consumo real com o teórico dos sacos produzidos; o ME consumido é detalhado em sacos e scoops. Ao fechar a produção, o cronómetro reinicia automaticamente.",
